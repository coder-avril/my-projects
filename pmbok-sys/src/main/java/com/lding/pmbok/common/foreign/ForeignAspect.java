package com.lding.pmbok.common.foreign;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.service.IService;
import com.lding.pmbok.common.foreign.anno.ForeignCascade;
import com.lding.pmbok.common.foreign.anno.ForeignField;
import com.lding.pmbok.common.foreign.anno.ForeignField.ForeignFields;
import com.lding.pmbok.common.foreign.info.ForeignFieldInfo;
import com.lding.pmbok.common.foreign.info.ForeignTableInfo;
import com.lding.pmbok.common.util.Classes;
...
public class ForeignAspect implements InitializingBean {
    private static final String FOREIGN_SCAN = "classpath*:com/lding/pmbok/pojo/po/**/*.class";
    @Autowired
    private ApplicationContext ctx;
    @Autowired
    private ResourceLoader resourceLoader;

    @Around("execution(* com.lding.pmbok.service..*.remove*(..))")
    ...
    @Around("execution(* com.lding.pmbok.service..*.save*(..)) || execution(* com.lding.pmbok.service..*.update*(..)) ")
